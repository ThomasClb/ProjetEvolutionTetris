...
class Tetris:
    ...
    def play(self, x, rotation, render=False, render_delay=None):
        ...
        score = 1 + (lines_cleared ** 2) * Tetris.BOARD_WIDTH # Gagne +1 a chaque fois qu'une piece tombe
        # score = 0 + (lines_cleared ** 2) * Tetris.BOARD_WIDTH
        self.score += score
    ...
    def render(self):
        ...
        img = img.repeat(25, axis=0).repeat(25, axis=1)
